...
const FormContact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Contactează Dentissima Clinique | Programează o consultație
        </title>
        <meta
          name="description"
          content="Completează formularul pentru a te programa la Dentissima Clinique. Te contactăm în cel mai scurt timp posibil."
        />
        <meta
          name="keywords"
          content="programare dentist Cluj, contact Dentissima, consultatie stomatologica"
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://dentissimaclinique.ro/form" />
      </Helmet>
